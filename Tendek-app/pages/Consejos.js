    ...
    return (
        ...
        >
            ...
            <View style={styles.header}>
                <TouchableOpacity onPress={() => setSide(true)}>
                    <Image source={require("../public/images/menu.jpg")} style={styles.imagensalir}></Image>
                </TouchableOpacity>
            ...
            <Text style={styles.titulo} blurRadius={4}>Titulo</Text>
